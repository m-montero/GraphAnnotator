...
default_annotate_layer_widgets <- list(colourInput = function(inputId, label = 'Colour',
                                                              showColour = "text", palette = "square", value = "#000000",
                                                              ...) colourpicker::colourInput(inputId = inputId, label = label,
                                                                                             showColour = showColour, palette = palette, value = value, ...),
...
annotateLayerServer <- function(id, plotHover = list(), plotClick = list(), plotDblClick = list(), plotBrush = list(),
                                selected = list(), plotName = "") {
  ...
  moduleServer(
    ...
    }) # close of inner moduleServer function
} # close of annotateLayerServer
